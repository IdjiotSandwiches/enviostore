                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr class="bg-white border-b hover:bg-gray-50">
                            <td class="p-4">
                                <img src="{{ $product->img }}" class="w-16 md:w-32 max-w-32 max-h-32" alt="{{ $product->name }}">
                            </td>
                            ...
                            <td class="py-4">
                                <a href="{{ route('admin.editProduct', $product->id) }}" class="bg-blue-600 text-white font-medium py-2 px-4 rounded-lg hover:bg-blue-700">Edit</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
