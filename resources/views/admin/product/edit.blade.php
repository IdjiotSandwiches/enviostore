            ...
            <div class="bg-primary rounded-lg shadow border border-gray-200 p-4 sm:p-6 md:p-8">
                <div class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Name (English) -->
                        <div>
                            <label for="name_en" class="block mb-2 text-sm font-medium text-font_primary">Name (English)</label>
                            <input type="text" name="name_en" id="name_en" @class([
                                ...
                                ]) value="{{ old('name_en', $product->name_en) }}" placeholder="Enter product name (English)" />
                            @error('name_en')
                        ...
                        <!-- Name (Indonesian) -->
                        <div>
                            <label for="name_id" class="block mb-2 text-sm font-medium text-font_primary">Name (Indonesian)</label>
                            <input type="text" name="name_id" id="name_id" @class([
                                    'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-button focus:border-button block w-full p-2.5',
                                    'border-red-500' => $errors->has('name_id'),
                                ]) value="{{ old('name_id', $product->name_id) }}" placeholder="Enter product name (Indonesian)" />
                            @error('name_id')
                                <p class="text-red-500 text-sm first-letter:uppercase">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2">
                            <label for="description_en" class="block mb-2 text-sm font-medium text-font_primary">Description (English)</label>
                        ...
                        <div class="md:col-span-2">
                            <label for="description_id" class="block mb-2 text-sm font-medium text-font_primary">Description (Indonesian)</label>
                        ...
                        <!-- Category -->
                        <div>
                            <label for="category_id" class="block mb-2 text-sm font-medium text-font_primary">Category</label>
                        ...
                        <div>
                            <label for="sustainability_score" class="block mb-2 text-sm font-medium text-font_primary">Sustainability Score</label>
                            <input type="number" name="sustainability_score" id="sustainability_score" step="0.01" @class([
                                ...
                                ]) value="{{ old('sustainability_score', $product->sustainability_score) }}" placeholder="Enter sustainability score" />
                        ...
                        <!-- Product Images -->
                        <div class="md:col-span-2">
                            <label for="product_images" class="block mb-2 text-sm font-medium text-font_primary">Product Image</label>
