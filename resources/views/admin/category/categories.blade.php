            ...
            <tbody>
                @foreach ($categories as $category)
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="py-4">
                            <a href="{{ route('admin.editCategory', $category->id) }}" class="bg-blue-600 text-white font-medium py-2 px-4 rounded-lg hover:bg-blue-700">{{ __('page.admin.edit') }}</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
