<button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
    class="text-white bg-button hover:bg-button/80 focus:ring-4 focus:outline-none focus:ring-bg-button/20 font-medium rounded-lg text-sm px-2.5 py-1.5 text-center inline-flex items-center"
    type="button">
    @if (app()->getLocale() === 'id')
