@props(['itemName', 'itemPrice', 'itemSeller', 'itemRating', 'itemReview'])

<a href="#" class="group max-w-xs w-80 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <div>
        <img class="rounded-t-lg w-full h-60 object-contain select-none" src="{{ asset('img/4.png') }}" alt="" />
    </div>
    <div
    ...
    >
        <div class="p-4 border-t">
            ...
            <div class="flex gap-2 items-center">
                ...
                <p class="font-normal text-gray-700 dark:text-gray-400">{{ "$itemRating | $itemReview Reviews" }}</p>
            </div>
        </div>
    </div>
</a>
