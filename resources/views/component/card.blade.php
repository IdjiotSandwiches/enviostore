@props(['link', 'rating', 'img', 'name', 'price'])

<div class="w-full max-w-xs md:max-w-md lg:max-w-xl bg-white border border-gray-200 rounded-lg shadow">
    <a href="{{ $link }}">
        <img class="w-full h-auto rounded-t-lg object-contain aspect-square" src="{{ $img }}" alt="product image" />
    </a>
    <div class="pt-2 px-3 md:px-4 lg:px-5 pb-5">
        ...
        <a href="#">
            <h5 class="text-sm md:text-sm lg:text-lg font-regular tracking-tight text-font_secondary dark:text-white">Company name</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-2.5">
            ...
            <span class= "text-sm md:text-sm font-regular pl-2 py-0.75 text-font_secondary">{{ $rating }}</span>
        </div>
