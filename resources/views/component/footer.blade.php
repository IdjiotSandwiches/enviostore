<footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="grid grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-2 md:grid-cols-3 text-sm md:pl-8">
                ...
                <div>
                    ...
                    <ul class="text-gray-900 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="#" class="hover:underline">Sustainable Development Goals</a>
                        </li>
                        <li>
                            <a href="#" class="hover:underline">Supply Chain Transparency</a>
                        </li>
                    </ul>
                </div>
                {{-- Legal and Notices --}}
                <div>
                    <h2 class="mb-4 text-md font-semibold text-gray-900 uppercase dark:text-white">Legal and Notices</h2>
                    <ul class="text-gray-900 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                ...
                {{-- Social Media --}}
                <div>
                    <h2 class="mb-4 text-md font-semibold text-gray-900 uppercase dark:text-white">Social Media</h2>
                    <ul class="text-gray-900 dark:text-gray-400 font-medium">
                        <li class="mb-4">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <span class="text-sm text-gray-900 sm:text-center dark:text-gray-400">© 2024 <a href="#" class="hover:underline">EnviroStore</a>. All Rights Reserved.</span>
        </div>
    </div>
</footer>
